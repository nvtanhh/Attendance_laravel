    ...
    <div class="limiter">
        <div class="container-login100">
            ...
            <div class="wrap-login100 p-t-72 p-b-80 col-md-4 col-sm-12">
                ...
                <form class="col-12 d-flex flex-column align-items-center mt-5" action="{{route('register')}}" method="POST">
                    @csrf
                    <div class="col-md-11">
                        <div class="box">
                            ...
                            <div class="wrap-input100 validate-input mt-4" data-validate="Name is required">
